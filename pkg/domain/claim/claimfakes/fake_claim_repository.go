...
func (fake *FakeClaimRepository) GetClaimsBySourceDigest(arg1 context.Context, arg2 string) ([]api.Claim, error) {
...
func (fake *FakeClaimRepository) GetClaimsBySourceDigestCallCount() int {
...
func (fake *FakeClaimRepository) GetClaimsBySourceDigestCalls(stub func(context.Context, string) ([]api.Claim, error)) {
	fake.getClaimsBySourceDigestMutex.Lock()
	defer fake.getClaimsBySourceDigestMutex.Unlock()
	fake.GetClaimsBySourceDigestStub = stub
}

func (fake *FakeClaimRepository) GetClaimsBySourceDigestArgsForCall(i int) (context.Context, string) {
	fake.getClaimsBySourceDigestMutex.RLock()
	defer fake.getClaimsBySourceDigestMutex.RUnlock()
...
func (fake *FakeClaimRepository) GetClaimsBySourceDigestReturns(result1 []api.Claim, result2 error) {
	fake.getClaimsBySourceDigestMutex.Lock()
	defer fake.getClaimsBySourceDigestMutex.Unlock()
...
func (fake *FakeClaimRepository) GetClaimsBySourceDigestReturnsOnCall(i int, result1 []api.Claim, result2 error) {
	fake.getClaimsBySourceDigestMutex.Lock()
	defer fake.getClaimsBySourceDigestMutex.Unlock()
	fake.GetClaimsBySourceDigestStub = nil
