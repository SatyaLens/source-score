...
type FakeSourceService struct {
	...
	updateAllScoresReturnsOnCall map[int]struct {
		result1 error
	}
...
func (fake *FakeSourceService) UpdateAllScoresReturns(result1 error) {
	...
	fake.updateAllScoresReturns = struct {
		result1 error
	}{result1}
}
...
func (fake *FakeSourceService) UpdateAllScoresReturnsOnCall(i int, result1 error) {
	...
	defer fake.updateAllScoresMutex.Unlock()
	fake.UpdateAllScoresStub = nil
	if fake.updateAllScoresReturnsOnCall == nil {
		fake.updateAllScoresReturnsOnCall = make(map[int]struct {
			result1 error
		})
	}
	fake.updateAllScoresReturnsOnCall[i] = struct {
		result1 error
	}{result1}
}
